...
package de.jeanpierrehotz.messaging.javaclient.messagescompat;

import de.jeanpierrehotz.messaging.javaclient.androidcompat.Preference;
import de.jeanpierrehotz.messaging.messages.*;
...
public class MessageLoader {
     ...
     */
    public static void saveMessages(Preference prefs, ArrayList<Message> msg){
     ...
     */
    public static void saveMessages(Preference prefs, ArrayList<Message> msg, int limit){
     ...
     */
    public static ArrayList<Message> loadMessages(Preference prefs){
